...
_dsp = uiNamespace getVariable [ "RscDisplayServerInfoMenu4", displayNull ];
if not ( isNull _dsp ) then
   {
      _cfgPath = missionConfigFile >> "CfgServerInfoMenu4";
      ...
      _listBoxItems = "isClass _x" configClasses ( missionConfigFile >> "CfgServerInfoMenu4" >> "menuItems" );
      {
