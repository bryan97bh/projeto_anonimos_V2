...
_dsp = uiNamespace getVariable [ "RscDisplayServerInfoMenu5", displayNull ];
if not ( isNull _dsp ) then
   {
      _cfgPath = missionConfigFile >> "CfgServerInfoMenu5";
      ...
      _listBoxItems = "isClass _x" configClasses ( missionConfigFile >> "CfgServerInfoMenu5" >> "menuItems" );
      {
