class RscDisplayServerInfoMenu5
{
   idd = 7770;
   onKeyDown = "if (_this select 1 isEqualTo 0x01) then { [] ExecVM 'scarCODE\ServerInfoMenu5\sqf\onEscape.sqf' }; true";
   onLoad = "uiNamespace setVariable ['RscDisplayServerInfoMenu5', _this select 0]; [] ExecVM 'scarCODE\ServerInfoMenu5\sqf\onLoad.sqf'; playSound ['ZoomIn', true]; 'DynamicBlur' ppEffectEnable true; 'DynamicBlur' ppEffectAdjust [7]; 'DynamicBlur' ppEffectCommit 0.1";
   onUnLoad = "uiNamespace setVariable ['RscDisplayServerInfoMenu5', displayNull]; playSound ['ZoomOut', true]; 'DynamicBlur' ppEffectAdjust [0]; 'DynamicBlur' ppEffectCommit 0.1";
   movingEnable = 1;
   #define GUI_GRID_X	(0)
   #define GUI_GRID_Y	(0)
   ...
   class controls
   {
      ...
      class menu:RscListbox
      {
         ...
         idc = 7;
         onLBSelChanged = "[] ExecVM 'scarCODE\ServerInfoMenu5\sqf\handleContent.sqf'";
      };
