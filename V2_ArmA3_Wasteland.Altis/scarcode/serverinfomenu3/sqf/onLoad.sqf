...
_dsp = uiNamespace getVariable [ "RscDisplayServerInfoMenu3", displayNull ];
if not ( isNull _dsp ) then
   {
      _cfgPath = missionConfigFile >> "CfgServerInfoMenu3";
      ...
      _listBoxItems = "isClass _x" configClasses ( missionConfigFile >> "CfgServerInfoMenu3" >> "menuItems" );
      {
