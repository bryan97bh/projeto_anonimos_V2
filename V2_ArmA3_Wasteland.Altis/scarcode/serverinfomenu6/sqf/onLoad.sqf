...
_dsp = uiNamespace getVariable [ "RscDisplayServerInfoMenu6", displayNull ];
if not ( isNull _dsp ) then
   {
      _cfgPath = missionConfigFile >> "CfgServerInfoMenu6";
      ...
      _ctrlHostedBy ctrlSetText format [ "EDITADO POR: %1", getText ( _cfgPath >> "hostedBy" ) ];
      ...
      _listBoxItems = "isClass _x" configClasses ( missionConfigFile >> "CfgServerInfoMenu6" >> "menuItems" );
      {
