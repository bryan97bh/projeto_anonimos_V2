...
_leader addHeadgear "H_HelmetO_ocamo";
...
_leader addWeapon "arifle_CTAR_hex_F";
_leader addPrimaryWeaponItem "muzzle_snds_58_hex_F";
...
_man2 addHeadgear "H_HelmetO_ocamo";
...
_man2 addWeapon "arifle_CTAR_hex_F";
...
_man3 addHeadgear "H_HelmetO_ocamo";
...
_man3 addWeapon "arifle_CTAR_hex_F";
...
sleep 0.1; // Without this delay, headgear doesn't get removed properly
_man4 addHeadgear "H_HelmetO_ocamo";
...
_man4 addWeapon "arifle_CTAR_GL_hex_F";
...
sleep 0.1; // Without this delay, headgear doesn't get removed properly
_man5 addHeadgear "H_HelmetO_ocamo";
...
_man5 addWeapon "arifle_CTAR_GL_hex_F";
...
sleep 0.1; // Without this delay, headgear doesn't get removed properly
_man6 addHeadgear "H_HelmetO_ocamo";
...
_man6 addWeapon "srifle_DMR_07_hex_F";
_man6 addPrimaryWeaponItem "muzzle_snds_65_TI_hex_F";
...
sleep 0.1; // Without this delay, headgear doesn't get removed properly
_man7 addHeadgear "H_HelmetO_ocamo";
_man7 addGoggles "G_WirelessEarpiece_F";
_man7 addUniform "U_O_CombatUniform_ocamo";
_man7 addVest "V_TacVest_khk";

_man7 addMagazine "100Rnd_580x42_hex_Mag_Tracer_F";
_man7 addWeapon "arifle_CTARS_hex_F";
_man7 addPrimaryWeaponItem "optic_Arco";
