...
_leader linkItem "NVGoggles_OPFOR";
_leader addHeadgear "H_HelmetLeaderO_oucamo";
_leader addGoggles "G_WirelessEarpiece_F";
_leader addUniform "U_O_CombatUniform_oucamo";
_leader addVest "V_TacVest_blk";

_leader addMagazine "30Rnd_580x42_Mag_Tracer_F";
_leader addWeapon "arifle_CTAR_blk_F";
_leader addPrimaryWeaponItem "muzzle_snds_58_blk_F";
...
sleep 0.1; // Without this delay, headgear doesn't get removed properly
_man2 linkItem "NVGoggles_OPFOR";
_man2 addHeadgear "H_HelmetLeaderO_oucamo";
_man2 addGoggles "G_WirelessEarpiece_F";
_man2 addUniform "U_O_CombatUniform_oucamo";
_man2 addVest "V_TacVest_blk";

_man2 addMagazine "30Rnd_580x42_Mag_Tracer_F";
_man2 addWeapon "arifle_CTAR_blk_F";
...
sleep 0.1; // Without this delay, headgear doesn't get removed properly
_man3 linkItem "NVGoggles_OPFOR";
_man3 addHeadgear "H_HelmetLeaderO_oucamo";
_man3 addGoggles "G_WirelessEarpiece_F";
_man3 addUniform "U_O_CombatUniform_oucamo";
_man3 addVest "V_TacVest_blk";

_man3 addMagazine "30Rnd_580x42_Mag_Tracer_F";
_man3 addWeapon "arifle_CTAR_blk_F";
...
sleep 0.1; // Without this delay, headgear doesn't get removed properly
_man4 addHeadgear "H_HelmetLeaderO_oucamo";
_man4 addGoggles "G_WirelessEarpiece_F";
_man4 addUniform "U_O_CombatUniform_oucamo";
_man4 addVest "V_TacVest_blk";

_man4 addMagazine "30Rnd_580x42_Mag_Tracer_F";
_man4 addWeapon "arifle_CTAR_GL_blk_F";
...
sleep 0.1; // Without this delay, headgear doesn't get removed properly
_man5 addHeadgear "H_HelmetLeaderO_oucamo";
_man5 addGoggles "G_WirelessEarpiece_F";
_man5 addUniform "U_O_CombatUniform_oucamo";
_man5 addVest "V_TacVest_blk";

_man5 addMagazine "30Rnd_580x42_Mag_Tracer_F";
_man5 addWeapon "arifle_CTAR_GL_blk_F";
...
sleep 0.1; // Without this delay, headgear doesn't get removed properly
_man6 addHeadgear "H_HelmetLeaderO_oucamo";
_man6 addGoggles "G_WirelessEarpiece_F";
_man6 addUniform "U_O_CombatUniform_oucamo";
_man6 addVest "V_TacVest_blk";

_man6 addMagazine "20Rnd_650x39_Cased_Mag_F";
_man6 addWeapon "srifle_DMR_07_blk_F";
...
sleep 0.1; // Without this delay, headgear doesn't get removed properly
_man7 addHeadgear "H_HelmetLeaderO_oucamo";
_man7 addGoggles "G_WirelessEarpiece_F";
_man7 addUniform "U_O_CombatUniform_oucamo";
_man7 addVest "V_TacVest_blk";

_man7 addMagazine "100Rnd_580x42_Mag_Tracer_F";
_man7 addWeapon "arifle_CTARS_blk_F";
_man7 addPrimaryWeaponItem "optic_Arco_blk_F";
...
sleep 0.1; // Without this delay, headgear doesn't get removed properly
_man8 addHeadgear "H_HelmetLeaderO_oucamo";
_man8 addGoggles "G_WirelessEarpiece_F";
_man8 addUniform "U_O_CombatUniform_oucamo";
_man8 addVest "V_TacVest_blk";

_man8 addMagazine "30Rnd_580x42_Mag_Tracer_F";
_man8 addWeapon "arifle_CTAR_blk_F";
...
sleep 0.1; // Without this delay, headgear doesn't get removed properly
_man9 addHeadgear "H_HelmetLeaderO_oucamo";
_man9 addGoggles "G_WirelessEarpiece_F";
_man9 addUniform "U_O_CombatUniform_oucamo";
_man9 addVest "V_TacVest_blk";

_man9 addMagazine "30Rnd_580x42_Mag_Tracer_F";
_man9 addWeapon "arifle_CTAR_blk_F";
...
sleep 0.1; // Without this delay, headgear doesn't get removed properly
_man10 addHeadgear "H_HelmetLeaderO_oucamo";
_man10 addGoggles "G_WirelessEarpiece_F";
_man10 addUniform "U_O_CombatUniform_oucamo";
_man10 addVest "V_TacVest_blk";

_man10 addMagazine "30Rnd_580x42_Mag_Tracer_F";
_man10 addWeapon "arifle_CTAR_blk_F";
