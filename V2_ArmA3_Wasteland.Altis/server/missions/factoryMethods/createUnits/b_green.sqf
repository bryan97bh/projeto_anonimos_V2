...
_leader linkItem "NVGogglesB_grn_F";
_leader addHeadgear "H_HelmetB_TI_tna_F";
_leader addGoggles "G_Balaclava_TI_G_tna_F";
_leader addUniform "U_B_CTRG_Soldier_F";
_leader addVest "V_PlateCarrierIAGL_oli";

_leader addMagazine "30Rnd_556x45_Stanag_Tracer_Green";
_leader addWeapon "arifle_SPAR_01_khk_F";
_leader addPrimaryWeaponItem "muzzle_snds_m_khk_";
_leader addPrimaryWeaponItem "acc_pointer_IR";
_leader addPrimaryWeaponItem "optic_ERCO_khk_F";
...
sleep 0.1; // Without this delay, headgear doesn't get removed properly
_man2 linkItem "NVGogglesB_grn_F";
_man2 addHeadgear "H_HelmetB_TI_tna_F";
_man2 addGoggles "G_Balaclava_TI_G_tna_F";
_man2 addUniform "U_B_CTRG_Soldier_F";
_man2 addVest "V_TacVest_oli";
_man2 addBackpack "B_AssaultPack_rgr_CTRGLAT_F";

_man2 addMagazine "30Rnd_556x45_Stanag_Tracer_Green";
_man2 addWeapon "arifle_SPAR_01_khk_F";
...
sleep 0.1; // Without this delay, headgear doesn't get removed properly
_man3 linkItem "NVGogglesB_grn_F";
_man3 addHeadgear "H_HelmetB_TI_tna_F";
_man3 addGoggles "G_Balaclava_TI_G_tna_F";
_man3 addUniform "U_B_CTRG_Soldier_F";
_man3 addVest "V_TacVest_oli";
_man3 addBackpack "B_FieldPack_green_F";

_man3 addMagazine "30Rnd_556x45_Stanag_Tracer_Green";
_man3 addWeapon "arifle_SPAR_01_khk_F";
_man3 addPrimaryWeaponItem "optic_Holosight";

_man3 addMagazine "Titan_AA";
_man3 addWeapon "launch_B_Titan_tna_F";
...
sleep 0.1; // Without this delay, headgear doesn't get removed properly
_man4 addHeadgear "H_HelmetB_TI_tna_F";
_man4 addGoggles "G_Balaclava_TI_G_tna_F";
_man4 addUniform "U_B_CTRG_Soldier_F";
_man4 addVest "V_TacVest_oli";

_man4 addMagazine "30Rnd_556x45_Stanag_Tracer_Green";
_man4 addWeapon "arifle_SPAR_01_GL_khk_F";
...
sleep 0.1; // Without this delay, headgear doesn't get removed properly
_man5 addHeadgear "H_HelmetB_TI_tna_F";
_man5 addGoggles "G_Balaclava_TI_G_tna_F";
_man5 addUniform "U_B_CTRG_Soldier_F";
_man5 addVest "V_TacVest_oli";

_man5 addMagazine "30Rnd_556x45_Stanag_Tracer_Green";
_man5 addWeapon "arifle_SPAR_01_GL_khk_F";
...
sleep 0.1; // Without this delay, headgear doesn't get removed properly
_man6 addHeadgear "H_HelmetB_TI_tna_F";
_man6 addGoggles "G_Balaclava_TI_G_tna_F";
_man6 addUniform "U_B_CTRG_Soldier_F";
_man6 addVest "V_TacVest_oli";

_man6 addMagazine "20Rnd_762x51_Mag";
_man6 addWeapon "arifle_SPAR_03_khk_F";
...
sleep 0.1; // Without this delay, headgear doesn't get removed properly
_man7 addHeadgear "H_HelmetB_TI_tna_F";
_man7 addGoggles "G_Balaclava_TI_G_tna_F";
_man7 addUniform "U_B_CTRG_Soldier_F";
_man7 addVest "V_TacVest_oli";

_man7 addMagazine "150Rnd_556x45_Drum_Green_Mag_Tracer_F";
_man7 addWeapon "arifle_SPAR_02_khk_F";
_man7 addPrimaryWeaponItem "optic_Holosight_khk_F";
...
sleep 0.1; // Without this delay, headgear doesn't get removed properly
_man8 addHeadgear "H_HelmetB_TI_tna_F";
_man8 addGoggles "G_Balaclava_TI_G_tna_F";
_man8 addUniform "U_B_CTRG_Soldier_F";
_man8 addVest "V_TacVest_oli";

_man8 addMagazine "30Rnd_556x45_Stanag_Tracer_Green";
_man8 addWeapon "arifle_SPAR_01_khk_F";
...
sleep 0.1; // Without this delay, headgear doesn't get removed properly
_man9 addHeadgear "H_HelmetB_TI_tna_F";
_man9 addGoggles "G_Balaclava_TI_G_tna_F";
_man9 addUniform "U_B_CTRG_Soldier_F";
_man9 addVest "V_TacVest_oli";

_man9 addMagazine "30Rnd_556x45_Stanag_Tracer_Green";
_man9 addWeapon "arifle_SPAR_01_khk_F";
...
sleep 0.1; // Without this delay, headgear doesn't get removed properly
_man10 addHeadgear "H_HelmetB_TI_tna_F";
_man10 addGoggles "G_Balaclava_TI_G_tna_F";
_man10 addUniform "U_B_CTRG_Soldier_F";
_man10 addVest "V_TacVest_oli";

_man10 addMagazine "30Rnd_556x45_Stanag_Tracer_Green";
_man10 addWeapon "arifle_SPAR_01_khk_F";
