...
_man7 addUniform "U_O_T_Soldier_F";
_man7 addVest "V_HarnessO_ghex_F";

_man7 addMagazine "100Rnd_580x42_ghex_Mag_Tracer_F";
_man7 addWeapon "arifle_CTARS_ghex_F";
_man7 addPrimaryWeaponItem "optic_Arco_ghex_F";
...
sleep 0.1; // Without this delay, headgear doesn't get removed properly
_man10 addHeadgear "H_HelmetLeaderO_ghex_F";
_man10 addGoggles "G_WirelessEarpiece_F";
_man10 addUniform "U_O_T_Soldier_F";
_man10 addVest "V_HarnessO_ghex_F";

_man10 addMagazine "30Rnd_580x42_Mag_Tracer_F";
_man10 addWeapon "arifle_CTAR_ghex_F";
