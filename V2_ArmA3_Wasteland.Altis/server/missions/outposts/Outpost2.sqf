...
[
	...
	["Box_IND_WpsSpecial_F", [-1.04126, 0.24707, 0], 286.415, { [_this, ["US", "OTHER"] call BIS_fnc_selectRandom] call fn_refillbox }],
	...
	["Box_East_WpsSpecial_F", [0.470947, -0.591309, 0], 85.8074, { [_this, ["RU", "OTHER"] call BIS_fnc_selectRandom] call fn_refillbox }],
