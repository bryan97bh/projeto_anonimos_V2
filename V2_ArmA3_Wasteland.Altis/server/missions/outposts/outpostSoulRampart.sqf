...
[
    ...
    //["Box_FIA_Wps_F", [4.75,-5,0],270, { [_this, ["US", "OTHER"] call BIS_fnc_selectRandom] call fn_refillbox }]
    ["Box_FIA_Wps_F", [-5,4.801,0],90, { [_this, ["MILITIA", "OTHER"] call BIS_fnc_selectRandom] call fn_refillbox }]
]